...
public class MyInfo extends JPanel implements ActionListener {
	...
	public MyInfo() {
		...
		registerPanel.add(submitButton, c);
	...
	public void setFields() {
		...
		idField.setText(Main.getUser().getId());
		passwordField.setText(Main.getUser().getPassword());
		nameField.setText(Main.getUser().getName());
		birthField.setText(Main.getUser().getBirth().toString());
		
		emailField.setText(Main.getUser().getEmail());
		phoneField.setText(Main.getUser().getPhone());
		passportNoField.setText(Main.getUser().getPassportNo());
	}
	...
	public void setChanged() {
		...
		if (selectedSex.equals("남성")) changed.setSex(Sex.MALE);
		else if (selectedSex.equals("여성")) changed.setSex(Sex.FEMALE);
		
		String birthString = birthField.getText();
		if (!birthString.equals("")) {
			DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");
			changed.setBirth(LocalDate.parse(birthString, formatter));
		}
	}
	...
	public boolean submit() {
		...
		changed.setUid(Main.getUser().getUid());
		Main.setUser(changed);
		return true;
	}
